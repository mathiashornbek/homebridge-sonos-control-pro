...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-123%20%2B%2094-4f46e5" alt="123 unit tests, 94 browser checks" />
</p>
...
```bash
npm test        # 123 unit and integration tests against a full mock Sonos household
npm run test:ui # 94 checks driving the real settings UI in Chromium
```
